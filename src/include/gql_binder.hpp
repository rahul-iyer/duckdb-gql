...
private:
	struct BindingScope {
        ...
        BindExpression(const GqlExpression &expression);
        const GqlExpression &
        ResolveValueExpression(const GqlExpression &expression) const;
        ...
        void ResetScopes();
        void PushScope();
        string ProjectionName(const GqlProjection &projection,
