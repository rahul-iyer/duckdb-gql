...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with-where/WithWhere6.feature
...
Feature: WithWhere6 - Filter on aggregates
  ...
  Scenario: [1] Filter a single aggregate
    ...
    When executing query:
      """
      MATCH (a)-->()
      LET __gql_with_scope_1 = 1, __gql_with_1_1_a = a, relCount = count(*)
      WHERE relCount > 1
      RETURN a
      """
