...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with-where/WithWhere4.feature
...
Feature: WithWhere4 - Non-Equi-Joins on variables
  ...
  Scenario: [2] Join with disjunctive multi-part predicates including patterns
    ...
    And having executed:
      """
      INSERT (a:TheLabel {id: 0}), (b:TheLabel {id: 1}), (c:TheLabel {id: 2})
      INSERT (a)-[:T]->(b),
             (b)-[:T]->(c)
      """
    When executing query:
