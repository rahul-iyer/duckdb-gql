...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with-where/WithWhere3.feature
...
Feature: WithWhere3 - Equi-Joins on variables
  ...
  Scenario: [3] Join between node properties of adjacent nodes
    ...
    When executing query:
      """
      MATCH (n)-[rel]->(x)
      LET __gql_with_scope_1 = 1, __gql_with_1_1_n = n, __gql_with_1_2_x = x
