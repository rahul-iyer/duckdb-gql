...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/remove/Remove1.feature
...
Feature: Remove1 - Remove a Property
  ...
  Scenario: [2] Remove multiple node properties
    ...
    And having executed:
      """
      INSERT (:L {num: 42, name: 'a', name2: 'B'})
      """
    When executing query:
      """
      MATCH (n)
  ...
  Scenario: [4] Remove multiple relationship properties
    ...
    And having executed:
      """
      INSERT (a), (b), (a)-[:X {num: 42, a: 'a', b: 'B'}]->(b)
      """
    When executing query:
      """
      MATCH ()-[r]->()
