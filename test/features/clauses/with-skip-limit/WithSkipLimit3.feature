...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with-skip-limit/WithSkipLimit3.feature
...
Feature: WithSkipLimit3 - Skip and limit
  ...
  Scenario: [3] Limiting amount of rows when there are fewer left than the LIMIT argument
    ...
    When executing query:
      """
      MATCH (a)
      LET __gql_with_scope_1 = 1, count = a.count
        ORDER BY a.count
        OFFSET 10
        LIMIT 10
      RETURN count
