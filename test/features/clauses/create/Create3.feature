...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/create/Create3.feature
...
Feature: Create3 - Interoperation with other clauses
  ...
  Scenario: [9] WITH-CREATE: A bound node should be recognized after projection with WITH + WITH
    ...
    When executing query:
      ...
      LET __gql_with_scope_2 = 1, __gql_with_2_1_value = *
      INSERT (b)
      INSERT (a)<-[:T]-(b)
      """
    Then the result should be empty
