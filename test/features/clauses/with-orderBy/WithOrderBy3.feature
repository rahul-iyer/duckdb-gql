...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with-orderBy/WithOrderBy3.feature
...
# which are otherwise lost after the WITH clause according to Cypher semantics
  ...
  Scenario Outline: [8] Fail on sorting by any number of undefined variables in any position #Example: <exampleName>
    ...
    When executing query:
      """
      LET __gql_with_scope_1 = 1, a = 1, b = 'b', c = 3, d = true
      LET __gql_with_scope_2 = 1, __gql_with_2_1_a = a, __gql_with_2_2_b = b
      LET __gql_with_scope_3 = 1, __gql_with_3_1_a = a
        ORDER BY <sort>
      RETURN a
      """
