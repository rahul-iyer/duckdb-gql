...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/merge/Merge8.feature
...
Feature: Merge8 - Merge relationships - on match and on create
  ...
  Scenario: [1] Using ON CREATE and ON MATCH
    ...
    And having executed:
      """
      INSERT (a:A {id: 1}), (b:B {id: 2})
      INSERT (a)-[:TYPE]->(b)
      INSERT (:A {id: 3}), (:B {id: 4})
      """
