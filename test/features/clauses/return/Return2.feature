...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/return/Return2.feature
...
Feature: Return2 - Return single expression (correctly projecting an expression)
  ...
  Scenario: [11] RETURN does not lose precision on large integers
    ...
    And having executed:
      """
      INSERT (:TheLabel {id: 4611686018427387905})
      """
    When executing query:
      """
      MATCH (p:TheLabel)
