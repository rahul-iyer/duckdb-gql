...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/return/Return4.feature
...
Feature: Return4 - Column renaming
  ...
  Scenario: [1] Honour the column name for RETURN items
    ...
    When executing query:
      """
      MATCH (a)
      LET __gql_with_scope_1 = 1, a = a.name
      RETURN a
      """
