...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/return/Return3.feature
...
Feature: Return3 - Return multiple expressions (if column order correct)
  ...
  Scenario: [2] Returning multiple node property values
    ...
    And having executed:
      """
      INSERT ({name: 'Philip J. Fry', age: 2046, seasons: [1, 2, 3, 4, 5, 6, 7]})
      """
    When executing query:
      """
      MATCH (a)
