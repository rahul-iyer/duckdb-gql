...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/match/Match6.feature
...
Feature: Match6 - Match named paths scenarios
  ...
  Scenario Outline: [25] Fail when matching a path variable bound to a value
    ...
    When executing query:
      """
      LET __gql_with_scope_1 = 1, p = <invalid>
      MATCH p = ()-[]-()
      RETURN p
      """
    Then a SyntaxError should be raised at compile time: VariableAlreadyBound
