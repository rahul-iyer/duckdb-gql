...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/match/Match3.feature
...
Feature: Match3 - Match fixed length patterns
  ...
  Scenario: [30] Fail when using a list or nodes as a node
    ...
    When executing query:
      """
      MATCH (n)
      LET __gql_with_scope_1 = 1, users = [n]
