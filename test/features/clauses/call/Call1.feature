...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/call/Call1.feature
...
Feature: Call1 - Basic procedure calling
  ...
  Scenario: [15] In-query procedure call should fail if shadowing an already bound variable
    ...
    When executing query:
      """
      LET __gql_with_scope_1 = 1, label = 'Hi'
      CALL test.labels() YIELD label
      RETURN *
      """
