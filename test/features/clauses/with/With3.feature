...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with/With3.feature
...
Feature: With3 - Forward multiple expressions
  ...
  Scenario: [1] Forwarding multiple node and relationship variables
    ...
    When executing query:
      """
      MATCH (a)-[r]->(b:X)
      LET __gql_with_scope_1 = 1, __gql_with_1_1_a = a, __gql_with_1_2_r = r, __gql_with_1_3_b = b
      MATCH (a)-[r]->(b)
      RETURN r AS rel
        ORDER BY rel.id
      """
