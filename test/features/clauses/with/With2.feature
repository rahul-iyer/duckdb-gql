...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/with/With2.feature
...
Feature: With2 - Forward single expression
  ...
  Scenario: [2] Forwarding a nested map literal
    ...
    When executing query:
      """
      LET __gql_with_scope_1 = 1, nestedMap = {name: {name2: 'baz'}}
