...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/return-orderby/ReturnOrderBy3.feature
...
Feature: ReturnOrderBy3 - Order by multiple expressions (order obey priority of expressions)
  ...
  Scenario: [1] Sort on aggregate function and normal property
    ...
    And having executed:
      """
      INSERT ({division: 'Sweden'})
      INSERT ({division: 'Germany'})
      INSERT ({division: 'England'})
      INSERT ({division: 'Sweden'})
      """
