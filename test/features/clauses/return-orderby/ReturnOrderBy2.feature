...
#encoding: utf-8
#
# Source: https://github.com/opencypher/openCypher/blob/677cbafabb8c3c5eed458fd3b1ec0daec8d67d23/tck/features/clauses/return-orderby/ReturnOrderBy2.feature
...
Feature: ReturnOrderBy2 - Order by a single expression (order of projection)
  ...
  Scenario: [13] Fail when sorting on variable removed by DISTINCT
    ...
    And having executed:
      """
      INSERT ({name: 'A', age: 13}), ({name: 'B', age: 12}), ({name: 'C', age: 11})
      """
    When executing query:
      """
      MATCH (a)
